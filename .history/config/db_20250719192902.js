...
Book.hasMany(Challenge, {
    foreignKey: 'bookId',
    as: 'challenges'
});

Challenge.belongsTo(Book, {
    foreignKey: 'bookId',
    as: 'book'
});
...
// UserAttempts associations
Challenge.hasMany(UserAttempts, {
    foreignKey: 'challengeId',
    as: 'attempts'
});

UserAttempts.belongsTo(Challenge, {
    foreignKey: 'challengeId',
    as: 'challenge'
});

User.hasMany(UserAttempts, {
    foreignKey: 'userId',
    as: 'attempts'
});

UserAttempts.belongsTo(User, {
    foreignKey: 'userId',
    as: 'user'
});
